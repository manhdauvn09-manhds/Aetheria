...
| 4 | Coding (sub-schedule below)                | 🟨     | 75 | 4.1–4.45 done; realtime PvP turns (`match:<id>` rooms, `pvp:action` w/ turn alternation, surrender, 30s deadline → forfeit, `match.end` redis bridge → api finalises) |
| 5 | Code review                                | ⬜     | 0  |                                                  |
