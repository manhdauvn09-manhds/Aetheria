...
| 4 | Coding (sub-schedule below)                | 🟨     | 77 | 4.1–4.46 done; Glicko-2 MMR — pure update + 0003_mmr_glicko migration (`rd`+`volatility`) + MmrService hooked into `MatchService.complete` |
| 5 | Code review                                | ⬜     | 0  |                                                  |
