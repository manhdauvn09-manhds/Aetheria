...
35. **NEXT — Step 4.33**: Quests service — `dailyForUser/weeklyForUser/progress(event)/claim` with the event bus. Subscribes to `ItemCrafted` (et al.) and updates `UserQuest.progress`. Vertical L, dep 4.32, 4.31.
