...
37. **NEXT — Step 4.35**: Battle Pass service (`currentSeason / progress / claim`) — subscribes to bus + uses `progression-runtime.grantAccountXp` for XP rewards. Vertical M, dep 4.32 + 4.34.
