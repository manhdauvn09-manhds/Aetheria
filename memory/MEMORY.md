...
32. **NEXT — Step 4.30**: Roster & Skills service (server) — `roster.list/unlockCharacter/ascend/equipSkin`, `skills.tree/invest/respec`. Vertical, depends on 4.7 (api boot) + 4.29 (progression).
