...
33. **NEXT — Step 4.31**: Inventory service (server) — `inventory.list/grant/consume/equip/craft`, server-authoritative; client mirrors to per-user SQLite. Vertical M, dep 4.7 (api boot) + 4.4 (schema-db).
