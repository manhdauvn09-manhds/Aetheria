...
43. **NEXT — Step 4.40**: `apps/realtime` boot — Socket.IO + Redis adapter + sticky-session helper. Horizontal M; first cut just stands up the server and a health probe; chat fan-out wires in 4.41.
