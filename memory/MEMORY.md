...
45. **NEXT — Step 4.42**: Web — Guild screen, Friends screen, Chat panel. Vertical L, deps 4.37 + 4.38 + 4.41. Will need a Socket.IO client wired to `apps/realtime` for live chat updates; auth via the existing JWT access token.
