...
34. **NEXT — Step 4.32**: Domain event bus + cross-cutting hooks (so quest/battle-pass/level-up consumers can subscribe to `inventory.granted`, `combat.completed`, etc.). Vertical S, dep 4.31.
