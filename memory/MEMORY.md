...
39. **NEXT — Step 4.37+**: Phase 4-F (Social: guild / friends / chat — 4.36–4.42 per `STEP4_SUB_SCHEDULE.md`) or Phase 4-G (PvP / Glicko-2 MMR / leaderboards — 4.43–4.48). Confirm which to pull next.
